...
if( $vsext -and ($vsVersion -eq "2015") ) {
    ...
    # Web Essentials 2015
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/ee6e6d8c-c837-41fb-886a-6b50ae2d06a2/file/146119/19/WebEssentials2015.vsix" `
                       -extensionFileName "WebEssentials2015.vsix" -vsVersion $vsVersion
    
    # jQuery Code Snippets
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/577b9c03-71fb-417b-bcbb-94b6d3d326b8/file/84997/5/jQueryCodeSnippets.vsix" `
                       -extensionFileName "jQueryCodeSnippets.vsix" -vsVersion $vsVersion
    
    # F# PowerTools
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/136b942e-9f2c-4c0b-8bac-86d774189cff/file/124201/29/FSharpVSPowerTools.vsix" `
    ...
    # GraphEngine VSExt
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/12835dd2-2d0e-4b8e-9e7e-9f505bb909b8/file/161997/13/GraphEngineVSExtension.vsix" `
                       -extensionFileName "GraphEngine.vsix" -vsVersion $vsVersion
    
    # Developer Assistant
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/5d01e3bd-6433-47f2-9c6d-a9da52d172cc/file/150980/4/DeveloperAssistant_2015.vsix" `
                       -extensionFileName "DevAssistant.vsix" -vsVersion $vsVersion
    
    # ImageWatch
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/e682d542-7ef3-402c-b857-bbfba714f78d/file/95399/6/ImageWatch.vsix" `
                       -extensionFileName "ImageWatch.vsix" -vsVersion $vsVersion
    
    # RegEx Tester
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/16b9d664-d88c-460e-84a5-700ab40ba452/file/31824/17/RegexTester-v1.5.1.vsix" `
                       -extensionFileName "RegExTester.vsix" -vsVersion $vsVersion
    
    # Windows IoT Template Project
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/06507e74-41cf-47b2-b7fe-8a2624202d36/file/166461/2/WindowsIoTCoreProjectTemplates.vsix" `
                       -extensionFileName "WinIoTTemplate.vsix" -vsVersion $vsVersion
    
    # Web Compiler
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/3b329021-cd7a-4a01-86fc-714c2d05bb6c/file/164873/10/Web%20Compiler%20v1.0.73.vsix" `
                       -extensionFileName "WebCompiler.vsix" -vsVersion $vsVersion
    
    # OpenCommandLine
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/4e84e2cf-2d6b-472a-b1e2-b84932511379/file/151803/15/Open%20Command%20Line%20v1.7.124.vsix" `
                       -extensionFileName "OpenCommandLine.vsix" -vsVersion $vsVersion
    
    # Refactoring Essentials for VS2015
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/68c1575b-e0bf-420d-a94b-1b0f4bcdcbcc/file/146895/14/RefactoringEssentials.vsix" `
                       -extensionFileName "RefactoringEssentials.vsix" -vsVersion $vsVersion
    
    # AllJoyn System Bridge Templates
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/aea0b437-ef07-42e3-bd88-8c7f906d5da8/file/165147/4/DeviceSystemBridgeTemplate.vsix" `
    ...
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/1177943e-cfb7-4822-a8a6-e56c7905292b/file/138960/2/dotNETPortabilityAnalyzer.vsix" `
                       -extensionFileName "NetPortabilityAnalyzer.vsix" -vsVersion $vsVersion

    # Caliburn Templates for VS2015
    InstallVSExtension -extensionUrl "https://visualstudiogallery.msdn.microsoft.com/b6683732-01ed-4bb3-a2d3-a633a5378997/file/165880/4/CaliburnUniversalTemplatePackage.vsix" `
